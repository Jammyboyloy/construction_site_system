        ...
        <div class="row pt-3 g-4">
          <div class="col-lg-4">
            ...
            >
              ...
              <div class="d-flex align-items-center gap-2 bg-main p-3 rounded-4 shadow-box">
                <n-avatar round :size="45" :src="supervisor.src" />
                <div>
                  <p class="m-0 mb-1 fs-6 fw-bold">{{ supervisor.name }}</p>
                  <p class="m-0 fs-7 text-secondary ls">{{ supervisor.email }}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-8">
            <n-data-table
              :columns="columns3"
              :data="data3"
              :pagination="data3.length >= 4 ? { pageSize: 3 } : false"
              :bordered="false"
...
const data2 = [
  { name: "Structural Steel", used: "62", remaining: "38", image: "https://i.pravatar.cc/40?img=1" },
  { name: "Concrete Mix",     used: "450", remaining: "55", image: "https://i.pravatar.cc/40?img=2" },
  { name: "Elec. Conduit",    used: "1.2", remaining: "82", image: "https://i.pravatar.cc/40?img=3" },
];
...
const columns2 = [
  {
    ...
    render: (row) =>
      h("div", { class: "d-flex align-items-center gap-3" }, [
        h(NAvatar, { src: row.image, round: true, size: 48, objectFit: "cover" }),
