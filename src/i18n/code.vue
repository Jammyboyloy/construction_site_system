        ...
        <div class="navbar-inner shadow-box">
          ...
          <div class="nav-info d-flex align-items-center">
            ...
            <n-dropdown
              ...
              :options="langOptions"
              @select="setLocale"
              @update:show="isLangOpen = $event"
              :theme-overrides="dropdownTheme"
              style="min-width: 40px; padding: 7px 4px"
            >
              <div
                class="lang-switcher"
                :class="{ 'lang-switcher--active': isLangOpen }"
              >
                <Earth :size="18" class="d-none d-sm-inline" />
                <span class="fs-6">{{ locale === "en" ? "En" : "Kh" }}</span>
                <ChevronDown
                  :size="14"
                  :style="{
...
const menuOptions = computed(() => [
  ...
  },
  {
    ...
    children: [
      {
        label: t("menu.createMember"),
        key: "/createMember",
        icon: renderIcon(User),
      },
      {
        label: t("menu.viewMember"),
        key: "/customers",
        icon: renderIcon(User),
      },
    ],
