...
const menuOptions = computed(() => [
  ...
  },
  {
    ...
    children: [
      {
        label: "Create Task",
        key: "/supervisor/createTask",
        icon: renderIcon(LayoutDashboard),
      },
      {
        label: "Preview Task",
        key: "/supervisor/PreviewTaskWorker",
        icon: renderIcon(LayoutDashboard),
      },
      {
        label: "View Task",
        key: "/supervisor/ViewTask",
  ...
  },
  {
    ...
    key: "/supervisor/createDailyReport",
    icon: renderIcon(LayoutDashboard),
  },
  {
    label: t("menu.settings"),
    key: "/supervisor/myProfile",
